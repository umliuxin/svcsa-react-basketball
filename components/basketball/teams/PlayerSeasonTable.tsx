...
const PlayerSeasonTable: React.FC<PlayerSeasonTableProps> = ({
  ...
  return (
    <div className="bg-white p-4 rounded-large shadow-small mt-4 w-full">
      ...
      <Table
        ...
        className="min-w-full bg-white rounded-xl shadow-small"
      >
        <TableHeader>
            ...
            playerSeasonAverages.map((avg: any) => {
              ...
              return (
                <TableRow key={player.id}>
                  ...
                  <TableCell className="text-center">
                    {avg?.points !== undefined ? avg.points.toFixed(1) : "N/A"}
                  </TableCell>
                  <TableCell className="text-center">
                  ...
                  <TableCell className="text-center">
                    {avg?.assist !== undefined ? avg.assist.toFixed(1) : "N/A"}
                  </TableCell>
                  <TableCell className="text-center">
